export default async function Layout ({ children, params }: { children: React.ReactNode, params: { year: string } }) {return (
    <main className='text-[#99aabb] min-h-screen'>
      ...
      <section className='px-[1.25rem] md:px-0 pt-[1rem] pb-[3rem] md:pt-[3rem] max-w-5xl mx-auto overflow-hidden'>
        <div>  
          <h1 className='text-[1.5rem] md:text-[2rem] text-[#ffffe9] font-semibold mb-[.75rem] md:mb-[1.25rem]'>{ params.year } Films</h1>
          { children }
        </div>
      </section>
    </main>
