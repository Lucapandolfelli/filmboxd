...
export default function UserLayout ({ children }: Props): JSX.Element {
  return (
    <main className='bg-gradient-to-tr from-[#000] to-[#0e1114] h-screen flex justify-center items-center px-[1.25rem]'>
      <section className='bg-[#14181c] max-w-[1000px] w-full h-[700px] flex flex-col md:flex-row shadow-2xl rounded-[.75rem] overflow-hidden'>
        <div className='h-[300px] md:h-full relative w-full md:w-[50%] bg-center bg-cover' style={{ backgroundImage: `url('/images/login.jpg')` }}>
